...
extern int part_edge_color_enabled;
extern int black_edge_color_enabled;
extern int dark_edge_color_enabled;
extern float part_edge_contrast;
extern float part_edge_saturation;
extern float part_color_value_ld_index;
extern int automate_edge_color;
extern int stud_style;
extern int is_lpub_highlight_color;
extern char lpub_highlight_color_prefix[];
